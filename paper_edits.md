...
| 5 | Sec. 4.5, paragraph | Fig. 4 references (left/right panels) | Table 1a references; one added sentence on SR_pc (T3) | +1 |
...
Net: −5 source lines; additions of new content 5 sentences (items 2, 4, 5), within the 6–8 line budget.
