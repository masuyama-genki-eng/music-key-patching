...
baseline (margin $+0.196$) where our synthetic-trained model does not---the
...
our $85$M model's key subspace transfers ($F_1$ $0.534$ \vs a $0.037$ selectivity
floor) but does \emph{not} beat the pitch surface: the corrected margin, $+0.034$
(CI $[-0.021,0.103]$), does not exclude zero. The Anticipatory Music
...
positions, with the same controls and rule (the two C3 baselines land at $0.451$ and
$0.454$, confirming the setups match), it reaches $F_1$ $0.690$ with a corrected
margin of $+0.196$ (CI $[0.132,0.260]$): \textbf{DR-H1 supported}. With architecture,
