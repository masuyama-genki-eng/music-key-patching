...
subspace (H3 as pre-registered asks for rank \emph{and} norm matching; we do not
rescale, and report the measured magnitudes instead---$\lVert\Delta\rVert$ $32.5$ \vs
$28.7$, ratio $1.13$, so the effect is not a magnitude artifact); \textbf{K2} sham edit, required bit-identical to the clean run (passed,
