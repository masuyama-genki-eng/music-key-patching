# Vendored verbatim from salu133445/mmt representation.py (MIT). See __init__.py.


# utils.inverse_dict is the one thing the constants need from mmt/utils.py; it is
# three lines, reproduced verbatim (MIT) so the vendored module stays self-contained.
class _Utils:
    @staticmethod
    def inverse_dict(d):
